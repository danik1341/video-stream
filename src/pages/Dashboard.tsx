        ...
        <>
          {!data ? (
            ...
            <div className="flex flex-col gap-8 bg-white pt-3 shadow sm:rounded-lg">
              ...
              <div>
                <dl className="mt-5 grid grid-cols-2 divide-y divide-gray-200 overflow-hidden rounded-2xl border border-gray-200 shadow-sm md:grid-cols-3 md:divide-x md:divide-y-0">
                  {stats.map((item) => (
