  ...
  const faqs = [
    {
      ...
      answer:
        "Creating a VidChillaccount is simple. Click on the 'Sign Up' button on the VidChill homepage. You'll need to enter your email, create a password, and fill out other details like your name. After you've filled out the necessary fields, click 'Submit'. You'll receive an email confirmation link. Once you click the link, your account is set up!",
    },
    {
      question: "How Do I Upload a Video?",
      answer:
        "Uploading a video on VidChillis straightforward. After logging into your account, click on the 'Upload' button located on the top-right corner of the screen. Select the video you wish to upload from your device. You can then add a title, description, and tags for your video. After finalizing the details, click 'Publish'. Please note, the time taken to upload a video depends on its file size and your internet speed.",
    },
    {
      question: "How Do I Edit My Profile?",
      answer:
        "To edit your VidChillprofile, go to your account by clicking on your profile icon located in the top-right corner of the screen. In the dropdown menu, click 'My Channel'. Here you can change your profile picture, channel description, and other settings. Remember to save your changes before leaving the page!",
    },
    {
      question: "Can I Download Videos from VidChill?",
      answer:
        "While VidChilldoesn't support direct video downloading due to copyright protection, users have the option to save videos offline within the VidChill app. Please respect the copyrights of video owners.",
    },
    {
      question: "Is VidChillFree to Use?",
      answer:
        "Yes, VidChillis free to use! We also offer VidChill Premium, a subscription service with additional features such as ad-free viewing, background play, and access to exclusive content.",
    },
    {
        ...
        <div className="mt-4">
          <div className="mx-auto max-w-3xl text-center ">
            ...
            <Button
              ...
              variant="primary"
              size="2xl"
              href="mailto:danik1341@gmail.com"
            >
              Contact
            </Button>
          </div>
