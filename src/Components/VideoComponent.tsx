  ...
  <div className=" mx-auto grid grid-cols-1 gap-x-4 gap-y-8 md:mx-0 md:max-w-none md:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 xl:mx-0 xl:max-w-none xl:grid-cols-3 2xl:mx-0 2xl:max-w-none 2xl:grid-cols-3">
    {videos.map((video, index) => {
      ...
      return (
        <Link
          href={`/video/${video.id}`}
          className="flex flex-col items-start justify-between hover:rounded-md hover:bg-gray-100"
          key={video.id}
        >
            ...
            <div className="max-w-xl">
              <div className=" relative mt-4 flex items-start gap-x-4">
                ...
                <div className="w-full">
                  <VideoTitle title={video.title} limitSize={true} />
    ...
    {videos.map((video, index) => {
      ...
      return (
        <Link href={`/video/${video.id}`} key={video.id}>
          <div className="my-5 flex flex-col gap-4 hover:rounded-md hover:bg-gray-100 lg:flex-row">
