    ...
    <>
      ...
      >
        <div className="flex grow flex-col gap-y-5 overflow-y-auto border border-gray-200 bg-white px-6 pb-4">
          <nav className="flex flex-1 flex-col space-y-7 pt-8">
          ...
          <div className="fixed inset-0 flex">
            ...
            >
              <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                ...
                <div className="flex flex-grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 pb-4">
                  <nav className="flex flex-1 flex-col pt-4">
                    <ul role="list" className="flex flex-1 flex-col gap-y-4">
                      ...
                      {sessionData ? (
                        <div className="my-2 flex flex-row rounded-lg bg-blue-300">
