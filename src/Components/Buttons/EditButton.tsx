...
export function EditButton({ video, refetch }: EditButtonProps) {
  ...
  const handleSubmit = () => {
    ...
    formData.append("file", croppedImage ? croppedImage : "");
    fetch(
      ...
      <Transition.Root show={open} as={Fragment}>
        ...
        >
          ...
          <div className="fixed inset-0 z-10 overflow-y-scroll">
            <div className="flex h-full min-h-full items-center justify-center overflow-auto p-4 text-center sm:p-0">
              <Transition.Child
                as={Fragment}
                enter="ease-out duration-300"
              ...
              >
                <Dialog.Panel className="relative h-3/4 transform overflow-y-auto overflow-x-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6 md:h-fit">
                  {/* ! step 1 End */}
                  {/* step 2 start */}
                  {currentPage === 1 && (
                    <>
                      ...
                      <div className=" relative mt-5 flex-row-reverse gap-2 space-x-2 sm:mt-4">
                        <Button
                          type="reset"
                          variant="primary"
                          size="lg"
